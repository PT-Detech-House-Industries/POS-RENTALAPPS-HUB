    ...
    <h3 class="row header smaller lighter purple">
      ...
      <span class="col-sm-6">
        <label class="pull-right inline">
          <a href="{{ route('owner.user.detail',[$data->id]) }}" class="btn btn-info btn-minier">
            Kembali
          </a>
        </label>
      </span><!-- /.col -->
...
<form class="form-horizontal" role="form" action="{{ route('owner.user.update', [$data->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
