    ...
    <div class="profile-wrapper-area py-3">
      ...
      <div class="card user-info-card">
        <div class="card-body p-4 d-flex align-items-center">
          ...
          <div class="user-info">
            <p class="mb-0 text-white">Selamat Datang</p>
      ...
      <div class="card user-data-card">
        <div class="card-body">
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            ...
            <div class="data-content">{{ Auth::user()->client->fullname }}</div>
          </div>
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            <div class="title d-flex align-items-center">
          ...
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            ...
            <div class="data-content">{{ Auth::user()->client->phone }}</div>
          </div>
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            <div class="title d-flex align-items-center">
          ...
          <div class="edit-profile-btn mt-3">
            <a class="btn w-100" href="{{ route('client.profile.edit',[Auth::user()->id]) }}"><i class="lni lni-pencil me-2"></i>
              Edit Profile
            </a>
          </div>
        </div>
      ...
      <div class="card user-data-card">
        <div class="card-body">
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            ...
            <div class="data-content">{{ Auth::user()->talent->fullname }}</div>
          </div>
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            <div class="title d-flex align-items-center">
              <i class="lni lni-user"></i><span>Nama Asli</span>
          ...
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            ...
            <div class="data-content">{{ Auth::user()->talent->phone }}</div>
          </div>
          <div class="single-profile-data d-flex align-items-center justify-content-between">
            <div class="title d-flex align-items-center">
              <i class="lni lni-envelope"></i><span>Email Address</span>
          ...
          <!-- Edit Profile-->
          <div class="edit-profile-btn mt-3"><a class="btn w-100"
              href="{{ route('talent.profile.edit',[Auth::user()->id]) }}"><i class="lni lni-pencil me-2"></i>Edit
              Profile</a></div>
        </div>
      </div>
    </div>
