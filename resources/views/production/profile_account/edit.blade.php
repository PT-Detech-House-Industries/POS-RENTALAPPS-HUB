    ...
    <div class="profile-wrapper-area py-3">
      @if (Auth::user()->hasRole('talent') )
        ...
        <div class="card user-data-card">
          <div class="card-body">
            <form class="form-horizontal" role="form" action="{{ route('talent.profile.edit', [$data->id]) }}"
      ...
      @if (Auth::user()->hasRole('client') )
        ...
        <div class="card user-data-card">
          <div class="card-body">
          @if (Auth::user()->hasRole('client') )
            <form class="form-horizontal" role="form" action="{{ route('client.profile.edit', [$data->id]) }}"
              method="post" enctype="multipart/form-data">
          @endif
          ...
          @endif
              ...
              <div class="mb-3">
                <div class="title mb-2"><i class="lni lni-user"></i><span>Nama Asli</span></div>
                <input name="fullname" class="form-control" type="text" value="{{ $data->client->fullname }}">
              </div>
              <div class="mb-3">
                <div class="title mb-2"><i class="lni lni-phone"></i><span>Phone</span></div>
                <input name="phone" class="form-control" type="text" value="{{ $data->client->phone }}">
              </div>
              <div class="mb-3">
                <div class="title mb-2"><i class="lni lni-envelope"></i><span>Email Address</span></div>
                <input name="email" class="form-control" type="email" value="{{ $data->email }}">
