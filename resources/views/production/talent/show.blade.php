    ...
    <h3 class="row header smaller lighter purple">
      ...
      <span class="col-sm-6">
        <label class="pull-right inline">
          ...
          <form id="delete" action="{{ route('owner.talent.destroy', [$data->id]) }}" method="POST" style="display: none;">
            @method('DELETE')
            @csrf
          </form>

          <a href="{{ route('owner.talent.edit', [$data->id]) }}" class="btn btn-success btn-minier">
            Edit Data
          </a>
